...
class _Gfx(Gfx):
    ...
    def load_wheels(self, chassis_model):
        ...
        try:
            self.front_right_wheel_np = eng.base.loader.loadModel(self.path + '/frontwheel')
            self.front_left_wheel_np = eng.base.loader.loadModel(self.path + '/frontwheel')
            self.rear_right_wheel_np = eng.base.loader.loadModel(self.path + '/rearwheel')
            self.rear_left_wheel_np = eng.base.loader.loadModel(self.path + '/rearwheel')
        except IOError:
            self.front_right_wheel_np = eng.base.loader.loadModel(self.path + '/wheel')
            self.front_left_wheel_np = eng.base.loader.loadModel(self.path + '/wheel')
            self.rear_right_wheel_np = eng.base.loader.loadModel(self.path + '/wheel')
            self.rear_left_wheel_np = eng.base.loader.loadModel(self.path + '/wheel')
